...
CREATE TABLE `dw_customer_medical_team` (
  `pk_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '主键id',
  `note` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '备注',
  `created_by` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '创建人',
  `created_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_by` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '更新人',
  `updated_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  `delete_flag` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除',
  `customer_master_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '客户 id',
  `job_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '职位 code',
  `job_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '职位名称',
  `place_code` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '地点 code',
  `place_region` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '地点区域',
  `is_main` bit(1) DEFAULT NULL COMMENT '是否为主',
  `staff_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '员工 id',
  `staff_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '员工姓名',
  `ding_staff_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '钉钉员工编号;从颗粒化获取班组信息',
  PRIMARY KEY (`pk_id`),
  KEY `idx_customer_master_id` (`customer_master_id`) USING BTREE,
  KEY `job_code` (`job_code`),
  KEY `staff_id` (`staff_id`),
  KEY `idx_dw_customer_medical_team` (`customer_master_id`,`job_code`,`staff_id`),
  KEY `idx_customer_master_id_delete_flag` (`customer_master_id`,`delete_flag`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='客户医疗团队信息-动态';

-- dc_ods.dw_customer_info definition

CREATE TABLE `dw_customer_info` (
  `customer_master_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '主键id',
  `note` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '备注',
  `created_by` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '创建人',
  `created_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_by` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '更新人',
  ...
  `delete_flag` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除',
  `name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '姓名',
  `nick_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '昵称',
  `phone` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '本人手机号[颗粒化，会议，app]',
  `use_phone` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '常用手机号[老crm手机号]',
  `register_phone` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '注册手机号[erp]',
  `contact_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '联系人姓名',
  `contact_phone` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '联系人手机号',
  `nationality` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '国籍',
  `id_card` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '身份证',
  `idcard_code` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '身份证映射码',
  `real_certification` bit(1) DEFAULT NULL COMMENT '是否实名',
  `passport_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '护照号',
  `birthday` date DEFAULT NULL COMMENT '生日;可通过身份证提取',
  `age` int DEFAULT NULL COMMENT '年龄;可通过身份证提取',
  `sex` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '性别;可通过身份证提取',
  `img_url` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '客户真实照片地址',
  `img_source` tinyint DEFAULT '0' COMMENT '真实照片来源:0-院内签到 1-会议上传 2-手动上传',
  `img_upload_time` datetime DEFAULT NULL COMMENT '真实照片上传时间',
  `nation` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '民族',
  `home_addr` varchar(900) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '居住地址',
  `home_province` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '居住地址-省',
  `home_city` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '居住地址-市',
  `home_area` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '居住地址-区',
  `home_no` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '居住地址-详细地址+门牌号',
  `post_addr` varchar(900) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '邮寄地址',
  `resident_addr` varchar(900) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '户籍地址',
  `education` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '文化程度',
  `marriage_status` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '婚育状态',
  `source` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '客户来源',
  `is_elite_super` bit(1) DEFAULT NULL COMMENT '是否精英超百',
  `customer_level` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '客户等级;一定时间范围内的消费对应等级',
  `customer_level_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '客户等级名称',
  `customer_type` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '客户类型',
  `customer_type_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '客户类型名称',
  `membership_level` tinyint(1) DEFAULT NULL COMMENT '会籍等级',
  `membership_card` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '会籍卡',
  `consumption_level` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '消费等级;所有的消费对应等级',
  `erp_customer_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'erp 客户编号',
  `his_customer_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'his 客户编号',
  `moyang_customer_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '摩漾客户编号',
  `gran_customer_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '颗粒化客户编号',
  `oldorder_customer_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '老订单客户编号',
  `oldcrm_customer_no` bigint DEFAULT NULL COMMENT '现 crm 客户编号',
  `medical_record_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '病例号',
  `customer_code` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '结算中台客户唯一码',
  `status` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '状态',
  `clothing_size` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '衣服尺码',
  `dietary_taboos` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '饮食禁忌',
  `is_team` tinyint(1) DEFAULT '0' COMMENT '是否有服务团队 0否 1是',
  PRIMARY KEY (`customer_master_id`),
  UNIQUE KEY `dw_customer_info_id_card_uindex` (`id_card`),
  UNIQUE KEY `dw_customer_info_pk` (`passport_no`),
  KEY `dw_customer_info_oldcrm_customer_no_index` (`oldcrm_customer_no`),
  KEY `dw_customer_info_erp_customer_no_index` (`erp_customer_no`),
  KEY `dw_customer_info_his_customer_no_index` (`his_customer_no`),
  KEY `dw_customer_info_moyang_customer_no_index` (`moyang_customer_no`),
  KEY `dw_customer_info_oldorder_customer_no_index` (`oldorder_customer_no`),
  KEY `dw_customer_info_medical_record_no_index` (`medical_record_no`),
  KEY `idx_dw_customer_info` (`oldcrm_customer_no`,`customer_master_id`),
  KEY `dw_customer_info_gran_customer_no_index` (`gran_customer_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='客户基础信息--静态信息';

select AES_DECRYPT_ECB('Cf+juYtlZX89MTuTgSVn82t4neBXBcSQESO6OnsZNGk=', 'SecuR2`4LeCzCoRe');



CREATE TABLE `ods_his_zt_lisresult` (
  `patient_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `gender_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `birthdaydate` date DEFAULT NULL,
  `age` int DEFAULT NULL,
  `source_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `test_no` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `item_name_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `results_rpt_date_time` datetime DEFAULT NULL,
  `report_item_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `report_item_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `result` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `print_context` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `units` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `abnormal_indicator` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `requested_date_time` (`requested_date_time`),
  KEY `item_name_code` (`item_name_code`),
  KEY `report_item_code` (`report_item_code`),
  KEY `ods_his_zt_lisresult_results_rpt_date_time_index` (`results_rpt_date_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='体检+门诊';

-- dc_ods.ods_his_zt_pacsresult definition

CREATE TABLE `ods_his_zt_pacsresult` (
  `infeepatientid` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `devicetype` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `devicename` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `itemcode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `studyscription` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `studytime` datetime DEFAULT NULL,
  `studystatusname` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reportdescribe` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reportdiagnose` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reportadvice` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `docname` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `operatetime` datetime DEFAULT NULL,
  `UniqueID` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `company_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '机构编码',
  PRIMARY KEY (`UniqueID`),
  KEY `infeepatientid` (`infeepatientid`),
  KEY `itemcode` (`itemcode`),
  KEY `studytime` (`studytime`),
  KEY `devicetype` (`devicetype`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


CREATE TABLE `ods_his_zt_customer` (
  `MED_RECORD_CODE` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '病历号',
  `CUSTOMER_NAME` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '姓名',
  `GENDER_NAME` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '性别',
  `SOURCE_NAME` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `BIRTHDAYDATE` date DEFAULT NULL COMMENT '生日',
  `Certification_NUM` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '证件号码',
  `CUSTOMER_TYPE_NAME` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '客户类型',
  `CUSTOMER_LEVEL_NAME` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '客户等级',
  `update_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`MED_RECORD_CODE`),
  KEY `idx_certification_num` (`Certification_NUM`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='his客户信息表';